...
@ImportResource("integration-context-publishsubscribechannel.xml")
public class SpringIntegrationApplication implements ApplicationRunner {
    ...
    public void run(ApplicationArguments arg0) throws Exception {
        ...
        for (int x = 0; x < 10; x++) {
            Message<String> message = MessageBuilder.withPayload("Printing message payload " + x).setHeader("messageNumber", x).build();
